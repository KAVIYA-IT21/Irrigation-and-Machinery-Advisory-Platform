...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: "slxr llta fgxj xksp", // Replace with the App Password generated from Google
  },
  ...
  try {
    ...
    if (todaySchedules.length > 0) {
      const emailPromises = todaySchedules.map((schedule) => {
        const scheduleDetails = `Date: ${schedule.date}\n
        Vegetable: ${schedule.vegetable_name}\n
        Time in Hrs: ${schedule.time_in_hrs}\n
        Part: ${schedule.part}`;
